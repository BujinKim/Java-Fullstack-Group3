 ...
 * 사용하기 편하도록 하는데 있습니다.
 * 
 * 1. 멤버중첩 클래스 : 이 클래스는 위치가 내부 클래스의 멤버 필드 위치로 선언되어있는 형태입니다.
...
//	}
	//중첩 클래스 정의합니다.
	//정의 위치가 멤버들(메서드 or 필드)가 같은 위치에 있기에, 멤버 중첩클래스라고 합니다.
	class Inner1_1{
		
		//Inner 클래스에서도 생성자, 필드, 메서드 모두 선언 및 저의가능함.
		int d = 400;
		...
		public void printData() {
			//inner 의 메서드는 outer의 private도 마음껏 접근 가능하다.
