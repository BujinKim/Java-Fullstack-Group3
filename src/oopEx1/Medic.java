...
public class Medic extends Terran implements Moveable {//클래스에는 public or default만 존재함.
	...
	// 생성자 오버로딩
//	public Medic() { //기본생성자.. 컴파일러가 넣어주는 기본 생성자가 어떤 역할을 하는지 코드로 정의합니다.
//		name = null; //멤버필드 초기화
//		rank = null;
//		hp = 0;
//		damage = 0;
...
//	}
	...
	public void healing(String target) {
		System.out.println(getTheUnit() + name + "이(가) " + target + "을 치료합니다.");
	}
